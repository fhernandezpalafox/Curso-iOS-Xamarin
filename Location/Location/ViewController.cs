...
namespace Location
{
	public partial class ViewController : UIViewController
	{
		...
		public void HandleLocationChanged (object sender, LocationUpdatedEventArgs e)
		{
			...
			{
				Title = "Anotacion",
				Coordinate = new CLLocationCoordinate2D(Manager.latitude, Manager.longitude)
			});

			Console.WriteLine ("foreground updated");

			Console.WriteLine("initial loc:" + Mapa.UserLocation.Coordinate.Latitude + "," + Mapa.UserLocation.Coordinate.Longitude);
		}
